...
namespace _16_DiameterofBT_efficientSoln
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int maxD = s.GetDiameterofBT(TestSolution.DesignBT7());
    ...
    class Solution
    {
        public int GetDiameterofBT(TreeNode root)
        {
            int maxHeight = GetMaxHeight(root);
            //maxHeight returns the max height of BT, but the value is not used
            return maxD;
        }

        // we use height function and modify it a bit
        // we have a gobal varaiable that tracks the max Diameter.
