using System;
/*
Diameter of a BT is defined as the number of nodes in the longest path from leaf to leaf.
*/
namespace _15DiameterOfaBT
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int res = s.GetDiameter(TestSolution.DesignBT1());
