...
namespace P4_preReq_check4Sibling
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var res = s.CheckForSibling(TestSolution.DesignBT1(), 9, 10);
    ...
    class Solution
    {
        public bool CheckForSibling(TreeNode root, int k, int l)
        {
            if (root == null) return false;
            if (root.left != null && root.right != null)
            {
                return (root.left.val == k && root.right.val == l) || (root.left.val == l && root.right.val == k) ||
                CheckForSibling(root.left, k, l) || CheckForSibling(root.right, k, l);
            }
            else if (root.left != null)
            {
                return CheckForSibling(root.right, k, l);
            }
