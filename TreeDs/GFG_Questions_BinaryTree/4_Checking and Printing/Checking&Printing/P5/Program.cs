...
namespace P5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var res = s.AreAtSameLevel(TestSolution.DesignBT3());
    ...
    class Solution
    {
        public bool AreAtSameLevel(TreeNode root)
        {
        ...
        bool Utility(TreeNode root, List<int> arr, int level)
        {
            if (root == null) return false;
            ...
            bool l = Utility(root.left, arr, level + 1);
            bool r = Utility(root.right, arr, level + 1);
            if (l || r) return true;
            else return false;
        }
