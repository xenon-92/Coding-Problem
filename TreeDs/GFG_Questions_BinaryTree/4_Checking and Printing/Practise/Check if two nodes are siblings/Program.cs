...
namespace Check_if_two_nodes_are_siblings
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var res = s.AreSiblings(TestSolution.DesignBT1(), 9, 10);
    ...
    class Solution
    {
        public bool AreSiblings(TreeNode root, int k, int l)
        {
            if (root == null) return false;
            if (root.left != null && root.right != null)
            {
                return (root.left.val == k && root.right.val == l) || (root.left.val == l && root.right.val == k) ||
                AreSiblings(root.left, k, l) || AreSiblings(root.right, k, l);
            }
            else if (root.left != null)
            {
                return AreSiblings(root.left, k, l);
            }
            else if (root.right != null)
            {
                return AreSiblings(root.right, k, l);
            }
            else
            {
                return false;
