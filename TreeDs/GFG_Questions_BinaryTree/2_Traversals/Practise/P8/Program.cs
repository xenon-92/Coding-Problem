...
namespace P8
{
    class Program
    {
        static void Print(TreeNode root)
        {
            if (root == null) return;
            Print(root.left);
            System.Console.Write(root.val + "------>" + root.prev?.val + " ");
            Print(root.right);
        ...
        static void Main(string[] args)
        {
            ...
            var root = TestSolution.DesignBT4();
            s.SetInorderPredecessor(root);
            Print(root);
    ...
    {
        TreeNode next = null;
        public void SetInorderSuccessor(TreeNode root)
        {
            if (root == null) return;
        ...
        TreeNode prev = null;
        public void SetInorderPredecessor(TreeNode root)
        {
            if (root == null) return;
            SetInorderPredecessor(root.left);
            root.prev = prev;
            prev = root;
            SetInorderPredecessor(root.right);
        }
    }
    class TestSolution
    {
