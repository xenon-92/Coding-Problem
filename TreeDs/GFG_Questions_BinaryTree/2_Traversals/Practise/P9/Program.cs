...
namespace P9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var res = s.FindSuccessor(TestSolution.DesignBT4(), 4);
    ...
    class Solution
    {
        public TreeNode FindSuccessor(TreeNode root, int k)
        {
            ...
            UtilityFindSuccessor(root, k);
            return next;
        }
        TreeNode next = null; TreeNode temp = null;
        void UtilityFindSuccessor(TreeNode root, int k)
        {
            if (root == null) return;
            UtilityFindSuccessor(root.right, k);
            if (root.val == k)
            {
                next = temp;
            }
            ...
            UtilityFindSuccessor(root.left, k);
        }
    }
    class TestSolution
    {
