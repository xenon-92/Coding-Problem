...
namespace printleft_view_of_BT
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            s.PrintLeftViewOfBT(TestSolution.DesignBT1());
        }
    }
    class TreeNode
    {
    ...
    {
        int maxlevel = 0;
        public void PrintLeftViewOfBT(TreeNode root)
        {
            UtilityPrintBFS(root);
            System.Console.WriteLine("you are already naked you have nothing to loose");
            Utilityprint(root, 1);
        }
        void UtilityPrintBFS(TreeNode root)
        {
            if (root == null) return;
        ...
        void Utilityprint(TreeNode root, int level)
        {
            if (root == null) return;
            if (level > maxlevel)
            {
            ...
            Utilityprint(root.left, level + 1);
            Utilityprint(root.right, level + 1);
        }
    }
    class TestSolution
    {
