...
namespace FindCeilingofBST
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var res = s.FindCeiling(TestSolution.DesignBST4(), 109);
            System.Console.WriteLine(res);
            var res1 = s.IterativeSolution(TestSolution.DesignBST4(), 109);
            System.Console.WriteLine(res1.val);
        }
    }
    ...
    class Solution
    {
        int ceil = 0; bool flag;
        public int FindCeiling(TreeNode root, int k)
        {
            Utility(root, k);
            if (flag) return k;
            return ceil;
        ...
        public TreeNode IterativeSolution(TreeNode root, int k)
        {
